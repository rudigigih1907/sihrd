...
class KaryawanController extends Controller
{
    ...
    public function actionCreate(){
        ...
        if($model->load(Yii::$app->request->post()) && $model->save()){
            ...
            Yii::$app->session->setFlash('success',
                ...
                Karyawan successfully created. ". Html::a('Klik link berikut jika ingin melihat detailnya', ['view', 'id' => $model->id], [ 'class' => 'btn btn-link'])
            );
    ...
    public function actionUpdate($id, $page = null){
        ...
        if($model->load(Yii::$app->request->post()) && $model->save()){
            Yii::$app->session->setFlash('info',
                FAS::icon(FAS::_THUMBS_UP) .  "
                Karyawan berhasil di update. ". Html::a('Klik link berikut jika ingin melihat detailnya', ['view', 'id' => $model->id], [ 'class' => 'btn btn-link'])
            );
    ...
    */
    public function actionDelete($id, $page = null){
        ...
        Yii::$app->session->setFlash('success', FAS::icon(FAS::_SAD_CRY) . " Karyawan successfully deleted.");
        return $this->redirect(['index', 'page' => $page]);
    }
