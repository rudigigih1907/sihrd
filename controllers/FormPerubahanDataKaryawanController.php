...
use app\models\search\FormPerubahanDataKaryawanSearch;
...
/**
 * FormPerubahanDataKaryawanController implements the CRUD actions for FormPerubahanDataKaryawan model.
 */
class FormPerubahanDataKaryawanController extends Controller {
    ...
    public function actionIndex() {
        $searchModel = new FormPerubahanDataKaryawanSearch();
    ...
    public function actionLaporanPeriode(){
        return $this->renderContent(
            ...
            Html::a(FAS::icon(FAS::_ARROW_ALT_CIRCLE_LEFT) ." Kembali", Yii::$app->request->referrer, [
