...
/**
 * UserFormPerubahanDataKaryawanSearch represents the model behind the search form about `app\models\FormPerubahanDataKaryawan`.
 */
class UserFormPerubahanDataKaryawanSearch extends FormPerubahanDataKaryawan {
    /**
     * @inheritdoc
     */
